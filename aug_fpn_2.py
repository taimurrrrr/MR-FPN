...
class ACF(nn.Module):
    ...
    def forward(self, input):
        ...
        x3 = self.batch(self.conv3x3_bn(input))
        x2 = self.batch(self.conv3x1_bn(input))
        x1 = self.batch(self.conv1x3_bn(input))
...
class AUG_FPN(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        # Lateral layers
        self.latlayer1_ = ACF(1024, 256,)

        self.latlayer2_ = ACF(512, 256)

        self.latlayer3_ = ACF(256, 256)
